...
<div class="container">
    ...
    <form class="form-signin" name="form" method="post" action="subscribe_action">
        ...
        <br>
        <button class="btn btn-lg btn-primary btn-block" type="submit" style="font-family: inherit">Send PIN</button>
    </form>
